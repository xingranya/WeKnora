...
func TestResolveProvider(t *testing.T) {
	cases := []struct {
		...
		{"SiliconFlow undocumented V4 Pro suffix falls back", provider.ProviderSiliconFlow, "deepseek-ai/DeepSeek-V4-Pro", baseProvider{}},
		{"SiliconFlow plain V4 falls back", provider.ProviderSiliconFlow, "deepseek-ai/DeepSeek-V4", baseProvider{}},
		{"SiliconFlow Pro alias falls back", provider.ProviderSiliconFlow, "Pro/deepseek-ai/DeepSeek-V4-Flash", baseProvider{}},
