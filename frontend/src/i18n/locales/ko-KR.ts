export default {
  ...
  integrations: {
    ...
    claw: {
      ...
      downloadCtaHint: '见外知识库 Skill 단일 패키지 · 내장 CLI bootstrap · v1.6.1',
  ...
  chat: {
    ...
    historyLoadFailed: '대화 기록을 불러오지 못했습니다. 네트워크를 확인한 후 다시 시도하세요.',
    retryHistoryLoad: '다시 불러오기',
    historyLoadMoreFailed: '이전 메시지를 불러오지 못했습니다.',
    retryHistoryLoadMore: '다시 시도',
  ...
  settings: {
    ...
    parser: {
      ...
      maxConcurrency: '최대 동시 처리',
      maxConcurrencyHint: 'MinerU 한도와 동일하게 설정하며 초과 작업은 WeKnora에서 대기합니다.',
  ...
  uploadConfirm: {
    ...
    parserFileSizeExceeded: '“{file}” 파일이 {engine} 분석 엔진의 {size}MB 제한을 초과했습니다. 다른 엔진을 선택하거나 파일을 나누세요.',
    urlItemLabel: 'URL',
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      deleteFailed: '폴더의 문서를 먼저 이동하거나 삭제하세요',
    },
    moveToFolder: {
      action: '폴더로 이동',
      newFolder: '새 하위 폴더',
    ...
    uploadQueue: {
      title: '업로드 대기열', summary: '미완료 작업 {count}개', empty: '업로드 작업이 없습니다',
      pause: '일시 중지', retry: '계속 또는 재시도', cancel: '취소', remove: '제거', selectFile: '원본 파일을 선택하여 계속',
      progress: '“{file}” 업로드 진행률: {percent}%',
      secondsLeft: '약 {count}초', minutesLeft: '약 {count}분', hoursLeft: '약 {count}시간',
      status: { queued: '대기 중', uploading: '업로드 중', paused: '일시 중지됨', needs_file: '원본 파일 필요', completing: '병합 중', waiting_parse: '분석 대기', parsing: '분석 중', status_unknown: '상태 확인 대기', completed: '완료', failed: '실패', cancel_requested: '취소 중', cancelled: '취소됨' },
      errors: { uploadFailed: '파일 업로드에 실패했습니다', parseTimeout: '분석 상태 확인 시간이 초과되었습니다', statusCheckFailed: '최신 상태를 일시적으로 확인할 수 없습니다. 자동 확인을 계속합니다.', parseTakingLonger: '처리 시간이 예상보다 길어지고 있습니다. 자동 확인을 계속합니다.', fileMismatch: '선택한 파일이 원본 업로드 파일과 일치하지 않습니다', parseRetryFailed: '분석을 다시 시작하지 못했습니다', cancelFailed: '작업을 취소하지 못했습니다', cancelStatusUnknown: '취소 결과를 일시적으로 확인할 수 없습니다. 자동 확인을 계속합니다.', sessionExpired: '업로드 세션이 만료되었습니다. 파일을 다시 업로드하세요.' },
    },
    ...
    documentLoadFailed: '문서를 불러오지 못했습니다. 네트워크를 확인한 후 다시 시도하세요.',
    retryLoadDocuments: '다시 불러오기',
    missingId: '지식베이스 ID가 없습니다',
    ...
    pdfDocFormat: 'PDF, Office, 이미지, 오디오 등 일반 형식을 지원합니다',
    textMarkdownFormat: '파일당 최대 2GB이며 업로드 후 자동으로 파싱 대기열에 추가됩니다',
