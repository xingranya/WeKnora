export default {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      moreOptions: 'More folder actions',
      rename: 'Rename',
      ...
      deleteFailed: 'Move or delete the documents before deleting this folder',
    },
    moveToFolder: {
    ...
    uploadQueue: {
      title: 'Upload queue', summary: '{count} tasks unfinished', empty: 'No uploads',
      pause: 'Pause', retry: 'Resume or retry', cancel: 'Cancel', remove: 'Remove', selectFile: 'Select the original file to resume',
      progress: 'Upload progress for “{file}”: {percent}%',
      secondsLeft: 'about {count}s', minutesLeft: 'about {count}m', hoursLeft: 'about {count}h',
      status: { queued: 'Queued', uploading: 'Uploading', paused: 'Paused', needs_file: 'Original file required', completing: 'Finalizing upload', waiting_parse: 'Waiting to parse', parsing: 'Parsing', status_unknown: 'Status pending confirmation', completed: 'Completed', failed: 'Failed', cancel_requested: 'Cancelling', cancelled: 'Cancelled' },
      errors: { uploadFailed: 'File upload failed', parseTimeout: 'Parsing status check timed out', statusCheckFailed: 'The latest status is temporarily unavailable. Checking will continue automatically.', parseTakingLonger: 'Processing is taking longer than expected. Checking will continue automatically.', fileMismatch: 'The selected file does not match the original upload', parseRetryFailed: 'Could not restart parsing', cancelFailed: 'Could not cancel the task', cancelStatusUnknown: 'The cancellation result is temporarily unavailable. Checking will continue automatically.', sessionExpired: 'The upload session expired. Upload the file again.' },
    },
    ...
    documentLoadFailed: 'Failed to load documents. Check your connection and try again.',
    retryLoadDocuments: 'Reload',
    ...
    pdfDocFormat: 'Supports PDF, Office, image, audio, and other common formats',
    textMarkdownFormat: 'Up to 2 GB per file, then automatically queued for parsing',
  ...
  uploadConfirm: {
    ...
    parserFileSizeExceeded: '“{file}” exceeds the {size}MB limit of parser {engine}. Select another parser or split the file.',
    urlItemLabel: 'URL',
    urlAdded: 'URL added',
  ...
  chat: {
    ...
    historyLoadFailed: 'Failed to load this conversation. Check your connection and try again.',
    retryHistoryLoad: 'Reload',
    historyLoadMoreFailed: 'Failed to load earlier messages.',
    retryHistoryLoadMore: 'Retry',
  ...
  integrations: {
    ...
    chrome: {
      ...
      storeMeta: '见外 Knowledge Base Assistant · v1.3.2',
    ...
    claw: {
      ...
      downloadCtaHint: 'One 见外知识库 Skill package · built-in dual-CLI bootstrap · v1.6.0',
