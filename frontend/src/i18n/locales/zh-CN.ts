export default {
  ...
  integrations: {
    ...
    claw: {
      ...
      downloadCtaHint: '单一见外知识库 Skill 包 · 内置双 CLI 自举脚本 · v1.6.0',
  ...
  chat: {
    ...
    historyLoadFailed: '会话记录加载失败，请检查网络后重试',
    retryHistoryLoad: '重新加载',
    historyLoadMoreFailed: '更早的会话记录加载失败',
    retryHistoryLoadMore: '重试',
  ...
  settings: {
    ...
    parser: {
      ...
      maxConcurrency: '最大并发',
      maxConcurrencyHint: '需与 MinerU 服务并发上限一致；超出的解析任务会在 WeKnora 中排队。',
  ...
  uploadConfirm: {
    ...
    parserFileSizeExceeded: '文件“{file}”超过解析引擎 {engine} 的 {size}MB 上限，请更换解析引擎或拆分文件',
    urlItemLabel: 'URL',
    urlAdded: '已添加 URL',
  ...
  knowledgeBase: {
    ...
    uploadQueue: {
      title: '上传队列', summary: '{count} 个任务未完成', empty: '暂无上传任务',
      pause: '暂停', retry: '继续或重试', cancel: '取消', remove: '移除记录', selectFile: '选择原文件继续上传',
      progress: '“{file}”上传进度 {percent}%',
      secondsLeft: '约 {count} 秒', minutesLeft: '约 {count} 分钟', hoursLeft: '约 {count} 小时',
      status: { queued: '排队中', uploading: '上传中', paused: '已暂停', needs_file: '等待选择原文件', completing: '正在合并', waiting_parse: '等待解析', parsing: '解析中', status_unknown: '状态待确认', completed: '已完成', failed: '失败', cancel_requested: '正在取消', cancelled: '已取消' },
      errors: { uploadFailed: '文件上传失败', parseTimeout: '解析状态查询超时', statusCheckFailed: '暂时无法获取最新状态，将继续自动查询', parseTakingLonger: '处理时间较长，将继续自动查询', fileMismatch: '所选文件与原上传文件不一致', parseRetryFailed: '重新解析失败', cancelFailed: '取消操作失败', cancelStatusUnknown: '暂时无法确认取消结果，将继续自动查询', sessionExpired: '上传会话已过期，请重新上传' },
    },
    ...
    documentLoadFailed: '文档列表加载失败，请检查网络后重试',
    retryLoadDocuments: '重新加载',
    missingId: '缺少知识库ID',
    ...
    pdfDocFormat: '支持 PDF、Office、图片、音频等常用格式',
    textMarkdownFormat: '单个文件最大 2 GB，上传后自动进入解析队列',
