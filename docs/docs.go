...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.CreateKnowledgeFolderRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/knowledge-bases/{id}/knowledge/uploads": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.InitializeKnowledgeUploadRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/knowledge-bases/{id}/knowledge/uploads/{upload_id}/complete": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/knowledge-bases/{id}/knowledge/uploads/{upload_id}/parts/{part_number}": {
            "put": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "字节范围，例如 bytes 0-4194303/8388608",
                        "name": "Content-Range",
                        "in": "header",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "internal_handler.CreateKnowledgeFolderRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "internal_handler.InitializeKnowledgeUploadRequest": {
            "type": "object",
            "required": [
                "file_name",
                "file_size"
